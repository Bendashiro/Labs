			...
			<div class="row">
				<div class="col-md-8 col-sm-7 blog-posts">
					...
					<div class="single-post">
						...
						<div class="author">
							<div class="avatar">
								<img src="<?= get_template_directory_uri(); ?>/img/avatar/03.jpg" alt="">
							</div>
				...
				<div class="col-md-4 col-sm-5 sidebar">
					...
					<div class="widget-item">
						...
						<ul class="instagram">
							<li><img src="<?= get_template_directory_uri(); ?>/img/instagram/1.jpg" alt=""></li>
							<li><img src="<?= get_template_directory_uri(); ?>/img/instagram/2.jpg" alt=""></li>
							<li><img src="<?= get_template_directory_uri(); ?>/img/instagram/3.jpg" alt=""></li>
							<li><img src="<?= get_template_directory_uri(); ?>/img/instagram/4.jpg" alt=""></li>
							<li><img src="<?= get_template_directory_uri(); ?>/img/instagram/5.jpg" alt=""></li>
							<li><img src="<?= get_template_directory_uri(); ?>/img/instagram/6.jpg" alt=""></li>
						</ul>
					</div>
					<!-- Single widget -->
					<div class="widget-item">
